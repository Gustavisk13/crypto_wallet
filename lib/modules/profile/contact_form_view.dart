...
class ContactFormView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ContactFormController contactFormController = ContactFormController();
    return SafeArea(
        child: Scaffold(
          ...
          child: Column(
            children: [
              ...
              DefaultInputComponent(
                  ...
                  validated: contactFormController.validateUserInput,
              ...
              DefaultInputComponent(
                  enableSuffixIcon: false,
                  validated: contactFormController.validateEmailInput,
              ...
              DefaultInputComponent(
                  enableSuffixIcon: false,
                  validated: contactFormController.validateMessageInput,
              ...
              SizedBox(
                  ...
                  child: DefaultButtonComponent(
                      toggleBorders: false,
                      onPressed: () async {
                        if (contactFormController.nameController.text.isEmpty ||
                            contactFormController
                                .emailController.text.isEmpty ||
                            contactFormController
                                .messageController.text.isEmpty) {
                          // Get.showSnackbar(SnackbarHandler.showSnackbarError('Preencha todos os campos'));
                          return;
                        }
                        contactFormController.isMailLoading = true;
                        await Future.delayed(const Duration(milliseconds: 300));
                        // Get.showSnackbar(SnackbarHandler.showSnackbarSuccess('Mensagem enviada com sucesso'));
                        contactFormController.isMailLoading = false;
                      },
                      child: !contactFormController.isMailLoading
                          ? const Text('Send')
