...
class HomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.put(CoinCarouselController());
    return SafeArea(
        child: SizedBox(
            width: Get.width,
                                ...
                                DefaultButtonComponent(
                                  ...
                                  onPressed: () {
                                    Get.to(() => const DefaultWebView(
                                          ...
                                          url:
                                              'https://learncrypto.com/knowledge-base/how-to-build-crypto',
                                        ));
                                  },
                                  child: Text(
                                    'Start Now',
                                ...
                                DefaultButtonComponent(
                                  ...
                                  onPressed: () {
                                    Get.to(() => const DefaultWebView(
                                          ...
                                          url:
                                              'https://learncrypto.com/knowledge-base/how-to-trade-crypto',
                                        ));
                                  },
                                  child: Text(
                                    'Refer Now',
                                ...
                                DefaultButtonComponent(
                                  ...
                                  onPressed: () {
                                    Get.to(() => const DefaultWebView(
                                          title: 'Rewards',
                                          url:
                                              'https://learncrypto.com/knowledge-base/how-to-use-crypto',
                                        ));
                                  },
                                  child: Text(
                                    'Share Now',
